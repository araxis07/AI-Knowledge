...
export function PageHeader({
  ...
  return (
    <section
      className={cn(
        "relative overflow-hidden rounded-[calc(var(--app-radius-card)+0.25rem)] border border-[var(--app-border)] bg-[linear-gradient(135deg,rgba(255,255,255,0.94),rgba(243,235,223,0.94))] p-7 shadow-[var(--app-shadow)] sm:p-9",
        className,
      )}
    >
      <div className="app-shell-glow left-[-5rem] top-[-3rem] h-40 w-40 bg-teal-500/16" />
      <div className="app-shell-glow bottom-[-4rem] right-[-3rem] h-44 w-44 bg-amber-400/18" />
